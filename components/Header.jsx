...
import AdamFace from '../public/adamface.png'
import GlobeIconAfrica from '../public/svg/BarsIcon'
import BarsIcon from '../public/svg/BarsIcon'
import AvatarIcon from '../public/svg/AvatarIcon'
import UserIcon from '../public/svg/UserIcon'
import UsersIconGroup from '../public/svg/UsersIconGroup'
import SearchIcon from '../public/svg/SearchIcon'
import Manatee from '../public/manatee.gif'
    ...
    >
      <div className='headerInner'>
        <div className='logo' onClick={() => router.push('/')}>
          <Image src={AdamFace} alt='adam face' className='h-16 w-16' />
          <span>
            Adam <br />
            &quot;The Manatee&quot; Gonzales
          </span>
        </div>
        <nav ref={navRef}>
        ...
        <form className='search'>
          <input
            ...
            placeholder={placeholder ? placeholder : 'What do you want to do?'}
